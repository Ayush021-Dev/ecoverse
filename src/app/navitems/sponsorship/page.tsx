export default function Sponsorship() {
  return (
    <section id="sponsorship" className="relative z-10 min-h-screen py-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {['Title Sponsor', 'Gold Sponsor', 'Silver Sponsor'].map((tier, index) => (
        ...
        <div className="text-center">
          <button className="px-8 py-4 bg-gradient-to-r from-emerald-500 to-green-600 text-white font-bold rounded-full hover:from-emerald-600 hover:to-green-700 transition-all transform hover:scale-105">
            Become a Sponsor
          </button>
        </div>
      </div>
